...
class ScatteringBase2DMul(ScatteringBase):
    ...
    def _document(cls):
        ...
        cls.__doc__ = ScatteringBase2DMul._doc_class.format(
        ...
        cls.scattering.__doc__ = ScatteringBase2DMul._doc_scattering.format(
            array=cls._doc_array,
            n=cls._doc_array_n)


# __all__ = ['ScatteringBase2D']
__all__ = ['ScatteringBase2DMul']
