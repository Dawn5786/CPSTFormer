...
def run_train(args):
    ...
    # top = topModelFactory( #create vit,cnn, mlp, linearlayer, or other
    #     base=scatteringBase,
    ...
    # midMul = midModelFactory(
    #     base=scatteringBaseMul,
    #     architecture=params['model']['midname'],
    #     num_layers=params['model']['midlayers']
    # )
...
def main():
    ...
    subparser.add_argument('--param_file', "-pf", type=str, default='/xxx/conf/parameters_multibatch_vit.yml',
                        help="YML Parameter File Name")
