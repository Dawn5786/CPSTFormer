...
from parametricSN.models.sn_hybrid_models_beifen import sn_HybridModel
...
def get_data_root(dataset_name, data_root, data_folder):
    ...
    if  data_root != None:
        ...
        DATA_DIR = '/xxx/tiny-imagenet-200'
    elif dataset_name=='imagenet-1k':
        DATA_DIR = '/xxx/ImageNet2012'
    return DATA_DIR
...
def main():
    ...
    subparser.add_argument('--param_file', "-pf", type=str, default='/xxx/conf/parameters_vit_image.yml',
