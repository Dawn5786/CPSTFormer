...
def main():
    ...
    #dataset
    subparser.add_argument("--dataset-name", "-dname", type=str, choices=['cifar', 'x-ray'])
    ...
    subparser.add_argument('--param_file', "-pf", type=str, default='/xxx/conf/parameters_vit.yml',
                        help="YML Parameter File Name")
