...
from parametricSN.models.sn_hybrid_models import sn_FusionModel
...
def run_train(args):
    ...
    hybridModel = sn_FusionModel(scatteringBase=scatteringBase, top=top).to(device) #create hybrid model
...
def main():
    ...
    subparser.add_argument("--model-name", "-mname", type=str, choices=['vit', 'cnn', 'mlp', 'linear_layer', 'resnet50'])
    ...
    # subparser.add_argument('--param_file', "-pf", type=str, default='/data1/lxt/work4-2023/Ablation/parametricScatteringNetworks-vit/conf/parameters_vit.yml',
    subparser.add_argument('--param_file', "-pf", type=str, default='/xxx/parameters_vit.yml',
                        help="YML Parameter File Name")
