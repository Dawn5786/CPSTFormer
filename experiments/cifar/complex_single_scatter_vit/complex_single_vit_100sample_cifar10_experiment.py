...
# RUN_FILE = "/data1/lxt/work4-2023/Ablation/parametricScatteringNetworks-vit/parametricSN/main_complex_single_vit.py"
RUN_FILE = "/mnt/data/lxt/work4-2023/Ablation/parametricScatteringNetworks-3090/parametricSN/main_complex_single_vit.py"
OPTIM = "sgd"
LR = 0.1
LRS = 0.1
LRO = 0.1
